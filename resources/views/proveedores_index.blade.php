...
@section('content')
                ...
                <ul class="list-group" style="width: 58rem; margin: 0 auto">
                    <li class="list-group-item" style="background-color:#e9871e">
                        <h2 style="color:#ffffff;">
                            Proveedores
                            <a style="color: white;margin-left: 655px; text-align: center;" href="{{route("proveedor.create")}}">
            ...
            @if($proveedores->count())
                <div class="table-responsive-sm -mr-2 col-md-10"
                    ...
                    <table name="tabla_prove" class="table">
                        <tr>
                            <thead style="background: #e9871e; color: #ffffff">
                            <th scope="col">Id</th>
                        ...
                        @foreach($proveedores as $item=>$proveedor)
                            <tr id="resultados">
                                <td style="font: caption; text-align: center">{{$proveedor->id}}</td>
                                <td style="font: caption; text-align: center">{{$proveedor->nombre_proveedor}}</td>
                                <td style="font: caption; text-align: center">{{$proveedor->correo_proveedor}}</td>
                                <td style="font: caption; text-align: center">{{$proveedor->telefono_proveedor}}</td>
                                <td style="font: caption; text-align: center">{{$proveedor->nombre_contacto_proveedor}}</td>
                                <td style="text-align: center">
                                    <a class="btn btn-primary" href="{{route('proveedor.show', ['id'=>$proveedor->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-layers-fill" viewBox="0 0 16 16">
                                ...
                                <td style="text-align: center">
                                    <a class="btn btn-success" href="{{route("proveedor.edit",["id"=>$proveedor->id])}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                ...
                                <td style="text-align: center">
                                    <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{$proveedor->id}}" onclick="recibir('{{$proveedor->id}}')">
                    ...
                    @else
                        <div class="alert alert-danger d-flex align-items-center" role="alert" style="margin-top: 15px">
                            ...
                            <div>
                                No hay proveedoress agregados aún, presiona el botón de agregar.
                            </div>
                        </div>
                    @endif
                </div>
    ...
    <script>
        function recibir(numero) {
            var id = numero;
            document.formulario_eliminar.action = "/proveedores/" + id + "/destroy";
        }
    </script>
@endsection
